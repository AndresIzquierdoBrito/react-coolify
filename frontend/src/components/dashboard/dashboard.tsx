...
function formatCalendarDate(value: string, locale: Locale) { return new Intl.DateTimeFormat(locale, { dateStyle: "medium" }).format(new Date(value.length === 10 ? `${value}T00:00:00.000Z` : value)); }
